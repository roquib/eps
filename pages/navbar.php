...
if ($teacher_login) {
    ...
    $SearchTeacher = mysqli_query(mysqli_connect("localhost", "root", "roquib", "ramr"), $sql);
    $SearchTeacher = mysqli_fetch_assoc($SearchTeacher);
}
// print_r($StudentName);
if ($student_login) {
    $sql = "select * from student where id='$student_login'";
    $SearchStudent = mysqli_query(mysqli_connect("localhost", "root", "roquib", "ramr"), $sql);
...
<div class="menu-area">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color:#47535af5!important">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href="/pages/logout.php" class="mr-2">Logout</a>
