...
$conn = mysqli_connect('localhost', 'root', 'roquib', 'ramr');
$id = $_GET['id'];
$searchTeacher = mysqli_query($conn, "select * from teacher where id='$id'");
$fetchArray = mysqli_fetch_assoc($searchTeacher);
$first_name = $fetchArray['first_name'];
$last_name = $fetchArray['last_name'];
$position = $fetchArray['position'];
$teacher_id = $fetchArray['id'];
    ...
    <div class="row my-2">
        <div class="col-lg-8 order-lg-2">
            <ul class="nav nav-tabs">
                ...
                <?php if ($_SESSION['teacher_login'] != '' && $type == $_SESSION['current_user']) : ?>
                    <li class="nav-item">
