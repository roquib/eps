...
$queryTeachers = mysqli_query(mysqli_connect('localhost', 'root', 'roquib', 'ramr'), "select id,first_name,last_name, position from teacher");
?>
<?php
include '../navbar.php';
?>
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_array($queryTeachers)) : ?>
                        <tr>
                            ...
                            <td><a href="SoftwareEngineering.php?id=<?php echo $row['id']; ?>"><?php echo $row['first_name'] . ' ' . $row['last_name']; ?></a></td>
                            <td><a href="SoftwareEngineering.php?id=<?php echo $row['id']; ?>"><?php echo $row['position']; ?></a></td>
